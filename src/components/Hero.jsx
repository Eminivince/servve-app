            ...
            <div className='md:flex space-x-9 mt-20 md:px-28 px-6 pb-20'>
                <div className='basis-1/2'>
                    ...
                    <div className='md:flex md:space-x-6 items-center mb-8'>
                        <div className='bg-rose-600 hover:bg-rose-900 duration-300 cursor-pointer flex w-fit p-3 rounded-lg justify-between space-x-6 font-bold text-white items-center mb-4 md:mb-0'>
                        ...
                        <div className='relative w-fit'>
                            ...
                            <div className='bg-rose-600 hover:bg-rose-900 duration-300 cursor-pointer p-2 rounded-xl w-fit absolute top-1 right-1 '>
                    ...
                    <div className='flex space-x-3 items-center text-sm'>
                        ...
                        <h1 className='font-medium p-2 bg-white rounded-lg text-rose-600 cursor-pointer'>Beauty Salon</h1>
                        <h1 className='font-medium p-2 bg-white rounded-lg text-rose-600 cursor-pointer'>Shifting</h1>
                        <h1 className='font-medium p-2 bg-white rounded-lg text-rose-600 cursor-pointer'>AC Repair</h1>
                        <h1 className='font-medium p-2 bg-white rounded-lg text-rose-600 cursor-pointer'>Wall Painting</h1>
                    </div>
                </div>
